...
>
> By default, all empty documents are treated as `null` and never excluded when loaded. This compromise has resulted in a lower pass rate (`89.05%`) when running the official [YAML Test Suite](https://github.com/yaml/yaml-test-suite) :)
